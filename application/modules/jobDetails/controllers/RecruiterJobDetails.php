...
class RecruiterJobDetails extends REST_Controller
{
    ...
    public function updateJobMaxCount_post()
    {
        ...
        $res = $this->RecruiterJobDetails_model->updateMaxCount($openingId, $oldMaxCountRecruiter, $newMaxCountRecruiter, $maxCount, $fixedShare, $bonusShare, $fixedShareInPerc, $bonusShareInPerc, $userName);
        $response = $res;
        $this->response($response, 200);
    }
